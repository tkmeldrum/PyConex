...
on_pos = [4.780008, -12.489893, -25.000333];

off_pos = [on_pos(1),0,0];
rev_pos = [on_pos(1), -on_pos(2), -on_pos(3)];
bad_pos1 = [on_pos(1)+3, 0,0];
...
filedir = 'Z:\Data\TKM\PM5\June2022\TiltTip\Epoxy31\CPMG_ONOFFBAD1\';
...
positions = repmat([on_pos;off_pos;rev_pos;bad_pos1],n_files,1); %%ADJUST FOR FULL ONOFF
% positions = repmat([on_pos;bad_pos1;bad_pos2],n_files,1); %%ADJUST FOR FULL ONOFF
positions = [(1:n_files*4)',positions]; %%ADJUST FOR FULL ONOFF
%%
