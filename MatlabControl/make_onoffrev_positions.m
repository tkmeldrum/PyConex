...
on_pos = [8.42, -25, -100];
off_pos = [on_pos(1),-on_pos(2),-on_pos(3)];
...
filedir = 'Z:\Data\LJK\PM5\December2021\HandCream\CPMG_ONREV\';
...
positions = repmat([on_pos;bad_pos1;bad_pos2;off_pos],n_files,1); %%ADJUST FOR FULL ONOFF
